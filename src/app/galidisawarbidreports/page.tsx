...
const gameTypes = [
    { value: "all", label: "All" },
    { value: "left-digit", label: "Left Digit" },
    { value: "right-panna", label: "Right Digit" },
    { value: "jodi-panna", label: "Jodi Digit" },
]
...
const StarlineBidReports = () => {
    ...
    const fetchBids = async () => {
        ...
        try {
            ...
            const response = await fetch(`/api/galidisawarbid?${params.toString()}`)
    ...
    const handleUpdateBid = async () => {
        ...
        setUpdating(true);
        try {
            const response = await fetch('/api/galidisawarbid', {
                method: 'PUT',
                headers: {
    ...
    const showDigitField = ['left-digit', 'right-digit', 'jodi-digit'].includes(formData.game_type);

    return (
        <div className="container mx-auto space-y-8 p-4">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold">Galidisawar Bid Report</h1>
