...
import { FiEdit, FiTrash2, FiSearch, FiChevronLeft, FiChevronRight, FiRefreshCcw } from "react-icons/fi";
...
export default function GalidisawarBidBackup() {
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <h2 className="text-2xl font-bold tracking-tight">Galidisawar Bid Backup</h2>
